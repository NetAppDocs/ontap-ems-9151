...
[.lead]
dbs.remote EMS events occur when ONTAP encounters issues associated with Distributed Block Store (DBS) cluster pair connectivity or remote replication capacity.
