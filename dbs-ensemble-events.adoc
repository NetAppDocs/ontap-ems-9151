...
[.lead]
dbs.ensemble events are presented when a Distributed Block Store (DBS) event related to the database ensemble occurs, such as inability to reach the database in a node.
