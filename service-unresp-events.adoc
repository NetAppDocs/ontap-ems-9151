...
[.lead]
service.unresp events are presented when a service such as Firefly or Slice Service is detected as unresponsive and that state is committed to the Zookeeper database.
