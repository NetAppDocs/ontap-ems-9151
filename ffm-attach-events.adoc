...
[.lead]
ffm.attach events are presented when volumes on an aggregate become available to protocol clients near the end of the attach phase of volume relocation.
