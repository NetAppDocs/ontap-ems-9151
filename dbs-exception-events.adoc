...
[.lead]
dbs.exception events are presented when the Distributed Block Store (DBS) is unable to process a cluster fault, which may require waiting for resolution or contacting NetApp technical support if the condition persists.
