...
[.lead]
service.resp events are presented when a service such as Firefly or Slice Service is detected as responsive and that state is committed to the Zookeeper database.
