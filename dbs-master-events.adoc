...
[.lead]
dbs.master events are presented when a node fails to execute cluster master startup, though the system attempts to start the cluster master again automatically.
