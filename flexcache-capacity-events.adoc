...
[.lead]
flexcache.capacity events are presented when the total cluster-wide FlexCache provisioned space has exceeded the licensed limit, which requires installing a new license to increase capacity.
