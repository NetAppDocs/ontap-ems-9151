...
[.lead]
xyz.trans events are presented when Copy-Free Transition's volume transition job responsible for transitioning 7-Mode volumes to clustered Data ONTAP starts or completes processing.
