...
[.lead]
master.demote events are presented when a node successfully updates the global database to demote the current cluster master, resulting in the promotion of a new cluster master.
