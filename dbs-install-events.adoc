...
[.lead]
dbs.install events are presented when a Distributed Block Store (DBS) install event occurs, such as inability to install system software on a pending node.
