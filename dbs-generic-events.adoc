...
[.lead]
dbs.generic events are presented when a Distributed Block Store (DBS) cluster fault is reported as a generic fault for events that manage the data backing FlexVol volumes.
