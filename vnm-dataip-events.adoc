...
[.lead]
vnm.dataip events are presented when a data IP address is being added to or removed from a node, changing data access availability through that IP address.
