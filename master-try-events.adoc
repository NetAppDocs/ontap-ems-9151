...
[.lead]
master.try EMS events occur when a node cannot connect to the current cluster master and attempts to demote it by making an associated global database change.
