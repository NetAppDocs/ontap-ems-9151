...
[.lead]
dbs.block events are presented when a Distributed Block Store (DBS) completes a block service repair operation involving block rewrites, which may require contacting NetApp technical support to assess severity.
