...
[.lead]
dbs.assignments events are presented when DBS block data distribution within the cluster changes, reflecting movement of the data that backs FlexVol volumes.
