...
[.lead]
dbs.unexpected events are presented when a Distributed Block Store (DBS) exception occurs unexpectedly, such as inability to analyze existing error information.
