...
[.lead]
dbs.raid events are presented when distributed block store detects that a RAID group in the cluster is degraded, which may require checking for disk errors or contacting NetApp technical support.
