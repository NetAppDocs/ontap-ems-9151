...
[.lead]
dbs.upgrade events are presented when Distributed Block Store (DBS) detects a software upgrade in progress for longer than 24 hours, which requires contacting NetApp technical support.
