...
[.lead]
dbs.provisioned EMS events occur when the distributed block store detects that the cluster's overall provisioned capacity has exceeded the slice reserve space threshold.
